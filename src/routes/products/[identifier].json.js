...
export async function get({ locale, params, query }, res) {
  const { identifier } = params
	const products = await contentful.getEntries({ content_type: 'product', locale, select: 'sys.id,fields.title,fields.identifier,fields.description,fields.photos,fields.price,fields.comingSoon', 'fields.identifier': identifier })
